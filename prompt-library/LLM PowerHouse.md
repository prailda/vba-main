...
- [[#Foundations of LLMs|Foundations of LLMs]]
	- [[#Foundations of LLMs#1. Mathematics for Machine Learning|1. Mathematics for Machine Learning]]
		- [[#1. Mathematics for Machine Learning#Further Exploration|Further Exploration]]
	- [[#Foundations of LLMs#2. Python for Machine Learning|2. Python for Machine Learning]]
		- [[#2. Python for Machine Learning#Further Exploration|Further Exploration]]
	- [[#Foundations of LLMs#3. Neural Networks|3. Neural Networks]]
		- [[#3. Neural Networks#Further Exploration|Further Exploration]]
	- [[#Foundations of LLMs#4. Natural Language Processing (NLP)|4. Natural Language Processing (NLP)]]
		- [[#4. Natural Language Processing (NLP)#Further Exploration|Further Exploration]]
- [[#Unlock the Art of LLM Science|Unlock the Art of LLM Science]]
	- [[#Unlock the Art of LLM Science#1. The LLM architecture 🏗️|1. The LLM architecture 🏗️]]
		- [[#1. The LLM architecture 🏗️#Further Exploration|Further Exploration]]
	- [[#Unlock the Art of LLM Science#2. Building an instruction dataset 📚|2. Building an instruction dataset 📚]]
		- [[#2. Building an instruction dataset 📚#Further Exploration|Further Exploration]]
	- [[#Unlock the Art of LLM Science#3. Pretraining models 🛠️|3. Pretraining models 🛠️]]
		- [[#3. Pretraining models 🛠️#Further Exploration|Further Exploration]]
	- [[#Unlock the Art of LLM Science#4. Supervised Fine-Tuning 🎯|4. Supervised Fine-Tuning 🎯]]
		- [[#4. Supervised Fine-Tuning 🎯#Further Exploration|Further Exploration]]
	- [[#Unlock the Art of LLM Science#RLHF 🔍|RLHF 🔍]]
		- [[#RLHF 🔍#Further Exploration|Further Exploration]]
	- [[#Unlock the Art of LLM Science#6. Evaluation 📊|6. Evaluation 📊]]
		- [[#6. Evaluation 📊#Further Evaluation|Further Evaluation]]
	- [[#Unlock the Art of LLM Science#7. Quantization ⚖️|7. Quantization ⚖️]]
		- [[#7. Quantization ⚖️#Further Exploration|Further Exploration]]
	- [[#Unlock the Art of LLM Science#8. New Trends 📈|8. New Trends 📈]]
		- [[#8. New Trends 📈#Further Exploration|Further Exploration]]
- [[#Building Production-Ready LLM Applications|Building Production-Ready LLM Applications]]
	- [[#Building Production-Ready LLM Applications#1. Running LLMs|1. Running LLMs]]
		- [[#1. Running LLMs#Further Exploration|Further Exploration]]
	- [[#Building Production-Ready LLM Applications#2. Building a Vector Storage|2. Building a Vector Storage]]
		- [[#2. Building a Vector Storage#Further Exploration|Further Exploration]]
	- [[#Building Production-Ready LLM Applications#3. Retrieval Augmented Generation|3. Retrieval Augmented Generation]]
		- [[#3. Retrieval Augmented Generation#Further Exploration|Further Exploration]]
	- [[#Building Production-Ready LLM Applications#4. Advanced RAG|4. Advanced RAG]]
		- [[#4. Advanced RAG#Further Exploration|Further Exploration]]
	- [[#Building Production-Ready LLM Applications#5. Inference Optimization|5. Inference Optimization]]
		- [[#5. Inference Optimization#Further Exploration|Further Exploration]]
	- [[#Building Production-Ready LLM Applications#6. Deploying LLMs|6. Deploying LLMs]]
		- [[#6. Deploying LLMs#Further Exploration|Further Exploration]]
	- [[#Building Production-Ready LLM Applications#7. Securing LLMs|7. Securing LLMs]]
		- [[#7. Securing LLMs#Further Exploration|Further Exploration]]
