...
topic:
  - GPT-5.2
  - Prompting
description: Prompting Guide for GPT-5.2 from OpenAI with example prompt for a web research agent
...
content: guide
publisher: OpenAI
url: https://cookbook.openai.com/examples/gpt-5/gpt-5-2_prompting_guide#example-prompt-for-a-web-research-agent
