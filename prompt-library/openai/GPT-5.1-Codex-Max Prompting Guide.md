...
topic:
  - Prompting
  - GPT-5.1
description: Prompting Guide for GPT-5.1-Codex-Max from OpenAI
...
# [Getting Started](https://cookbook.openai.com/examples/gpt-5/gpt-5-1-codex-max_prompting_guide#getting-started)
...
2. Update your tools, including our apply_patch implementation and other best practices below. This is a major lever for getting the most performance from GPT-5.1-Codex-Max.

# [Prompting](https://cookbook.openai.com/examples/gpt-5/gpt-5-1-codex-max_prompting_guide#prompting)

## [Recommended Starter Prompt](https://cookbook.openai.com/examples/gpt-5/gpt-5-1-codex-max_prompting_guide#recommended-starter-prompt)
...
## [Mid-Rollout User Updates](https://cookbook.openai.com/examples/gpt-5/gpt-5-1-codex-max_prompting_guide#mid-rollout-user-updates)
...
## [Using agents.md](https://cookbook.openai.com/examples/gpt-5/gpt-5-1-codex-max_prompting_guide#using-agentsmd)
...
# [Compaction](https://cookbook.openai.com/examples/gpt-5/gpt-5-1-codex-max_prompting_guide#compaction)
...
# [Tools](https://cookbook.openai.com/examples/gpt-5/gpt-5-1-codex-max_prompting_guide#tools)
...
### [Apply_patch](https://cookbook.openai.com/examples/gpt-5/gpt-5-1-codex-max_prompting_guide#apply_patch)
...
### [Shell_command](https://cookbook.openai.com/examples/gpt-5/gpt-5-1-codex-max_prompting_guide#shell_command)
...
### [Update Plan](https://cookbook.openai.com/examples/gpt-5/gpt-5-1-codex-max_prompting_guide#update-plan)
...
### [View_image](https://cookbook.openai.com/examples/gpt-5/gpt-5-1-codex-max_prompting_guide#view_image)
...
## [Dedicated terminal-wrapping tools](https://cookbook.openai.com/examples/gpt-5/gpt-5-1-codex-max_prompting_guide#dedicated-terminal-wrapping-tools)
...
## [Other Custom Tools (web search, semantic search, memory, etc.)](https://cookbook.openai.com/examples/gpt-5/gpt-5-1-codex-max_prompting_guide#other-custom-tools-web-search-semantic-search-memory-etc)
...
## [Parallel Tool Calling](https://cookbook.openai.com/examples/gpt-5/gpt-5-1-codex-max_prompting_guide#parallel-tool-calling)
...
## [Tool Response Truncation](https://cookbook.openai.com/examples/gpt-5/gpt-5-1-codex-max_prompting_guide#tool-response-truncation)
